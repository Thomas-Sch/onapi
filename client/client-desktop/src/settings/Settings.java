...
public class Settings extends DefaultsSettings {
   ...
   public void loadSettings() {
      ...
      try {
         ...
         Logs.errors.push("Settings", "Unable to open and read the file \""
               + file.getName() + "\".");
      }
      catch (JDOMParseException e) {
         Logs.errors.push("Settings", "The file \"" + file.getName()
               + "\" is corrupted.");
      }
   ...
   public void saveSettings() {
      ...
      try {
         ...
         Logs.errors.push("Settings", "Unable to create the config file.");
      }
      finally {
   ...
   private enum XMLNodes implements HasXMLName {
      SETTINGS, PROPERTIES, LANGUAGE_CODE, FRAMES, FRAME_SETTINGS, WIDTH, HEIGHT, POSITION_X, POSITION_Y, ANCHOR;
