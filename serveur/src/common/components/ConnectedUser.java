...
/**
 * Représente les informations génériques d'un utilisateur connecté au serveur,
 * à savoir son nom, son identifiant, etc. Fourni les méthodes pour traiter ces
 * informations.
 * 
...
public class ConnectedUser extends ObservableComponent implements Serializable {
    ...
    * 
    * @param userId
    *           - son identifiant pour le serveur.
    * @param activity
    *           - son activité au sein du serveur.
    * @param accountName
    *           - son nom de compte.
    */
